        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
					...
					<li>
                        <a href="roombook.php"><i class="fa fa-bar-chart-o"></i> Tent Booking</a>
                    </li>
                    <li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Status <small>Tent Booking </small>
                        </h1>
                    </div>
                </div>
                <!-- /. ROW  -->
                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
											...
											<button class="btn btn-default" type="button">
												 New Tent Bookings  <span class="badge"><?php echo $c ; ?></span>
											</button>
											</a>
                                        </h4>
                                    </div>
                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
											...
											<button class="btn btn-primary" type="button">
												 Booked Tents <span class="badge"><?php echo $r ; ?></span>
											</button>
